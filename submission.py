...
X_test['TransactionAmt'] = X_test['TransactionAmt_decimal']
del X_test['TransactionAmt_decimal']
...
X_test['identity']=X_test.card1.astype(str)+'_'+X_test.card2.astype(str)+'_'+X_test.card3.astype(str)+'_'+ \
X_test.card4.astype(str)+'_'+X_test.card5.astype(str)+'_'+X_test.card6.astype(str)
...
X_test.identity=X_test.identity.astype(str)+'_'+X_test.addr1.astype(str)+'_'+X_test.addr2.astype(str)+'_'+X_test.P_emaildomain.astype(str)+'_'+X_test.R_emaildomain.astype(str)
X_test.identity=X_test.identity.astype('category')
...
print('Writing to sub.csv')
sub = pd.read_csv(f'{folder_path}sample_submission.csv')
sub = pd.read_csv(f'{folder_path}sample_submission.csv')
sub.isFraud = y_preds
sub.to_csv(f'{folder_path}sample_submission.csv', index=False)
